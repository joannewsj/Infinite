<template>
    <div>
        <div class="infinity-loader">
            <div class="bg"><!--background circles-->
...
.infinity-loader .bg div, .infinity-loader > .fg > div > div{
    width: 70px;/* width */
    height: 70px;/* width */
    border: 10px solid transparent;/* border-width solid #aaa */
...
.infinity-loader > .fg > .top-right-rect > div{
    animation-delay: .75s;/* (2 x time)/4 */
}
...
.infinity-loader > .fg > .bottom-left-rect > div{
    animation-delay: 1.125s;/* (3 x time)/4 */
}

.infinity-loader > .fg {
    filter: drop-shadow(0 0 6px $first-color);
}

@keyframes spin {
    50%, 100%{transform: rotate(495deg)}/* (360 + 135)deg*/
}
</style>
